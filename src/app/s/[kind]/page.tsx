...
> = {
  major: {
    ...
    description:
      "오늘 국토부에 공개된 수도권 15억 이상 아파트 중개거래(직거래·해제 제외)를 가격순으로. 출처: 국토교통부 실거래가 공개시스템.",
  ...
  strong: {
    ...
    description:
      "같은 단지·평형의 최근 60일 내 직전 실거래보다 눈에 띄게 높게 팔린 중개거래. 이중 합의 게이트로 선별. 출처: 국토교통부 실거래가 공개시스템.",
    right: "직전 실거래 대비 · 상승순",
  },
  weak: {
    corner: "오늘의 약세 동네",
    ...
    description:
      "시군구별로 오늘 공개된 중개거래의 직전 실거래 대비 평균 등락. 5건 이상 동네만 — 하락 단지 실명은 싣지 않습니다. 출처: 국토교통부 실거래가 공개시스템.",
  ...
  recovery: {
    ...
    description:
      "수도권 82개 시군구를 전고점 대비 회복률로 색칠한 지도. 국민평형(전용 84㎡급) 실거래 중위 기준 — 시세 지수 아님. 출처: 국토교통부 실거래가 공개시스템.",
  ...
  trade: {
    ...
    description:
      "오늘 국토부에 공개된 수도권 시군구별 실거래 건수를 색 농도로 그린 지도. 직거래·해제 제외. 출처: 국토교통부 실거래가 공개시스템.",
    right: "오늘 공개 건수 · 시군구",
  },
  temp: {
    corner: "오늘의 온도",
    ...
    description:
      "오늘 공개된 수도권 아파트 실거래 중 직전 실거래보다 높게 팔린 비율을 폭등기('20.11~'21.10)·급락기('22) 관측 평균, 시계열 최저점과 나란히. 판정 없이 관측값만. 출처: 국토교통부 실거래가 공개시스템.",
