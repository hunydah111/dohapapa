      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", flex: 1, marginLeft: 40 }}>
            <div style={{ fontSize: 78, color: "#3a322c", lineHeight: 1.12 }}>내 돈으로</div>
            <div style={{ fontSize: 78, color: "#3a322c", lineHeight: 1.12 }}>살 집 어디까지?</div>
            <div style={{ display: "flex", flexDirection: "row", gap: 12, marginTop: 24 }}>
              {chip("안정형", "#e0a23a")}
              {chip("균형형", "#fe7644")}
              {chip("도전형", "#3a322c")}
            </div>
            <div style={{ fontSize: 29, color: "#6b6157", marginTop: 24 }}>
        ...
        >
          <div style={{ fontSize: 88, color: "#fffdf8", lineHeight: 1 }}>비집고</div>
          <div style={{ fontSize: 32, color: "#ffe6dc" }}>
